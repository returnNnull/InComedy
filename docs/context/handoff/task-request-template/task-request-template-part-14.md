...
- Current constraints:
  ...
  - The bootstrap guidance for new chats must surface the rule set before implementation begins.
...
- What should be delivered:
  ...
  - ensure new chat bootstrap guidance surfaces both rules up front

## Scope

- In scope:
  - strengthen engineering rules and quality gates
  - update the bootstrap guidance
...
- Functional result:
  ...
  - the bootstrap guidance tells new chats to follow both rules before implementation
