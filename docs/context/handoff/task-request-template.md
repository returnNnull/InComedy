...
6. `task-request-template/task-request-template-part-06.md` (Telegram auth browser handoff regression fix requests from 2026-03-13)
7. `task-request-template/task-request-template-part-07.md` (Telegram official OIDC alignment request from 2026-03-13)

## Append Rule

- Append new formalized requests to the latest part file: `task-request-template/task-request-template-part-07.md`.
- If the latest part grows above ~8,000 characters, create `task-request-template/task-request-template-part-08.md`, update this index, and continue appending there.
