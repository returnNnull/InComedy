...
3. `decision-traceability/decision-traceability-part-03.md` (`D-041` -> present)

## Append Rule

- Append new decision entries to `decision-traceability/decision-traceability-part-03.md`.
- If the latest part grows above ~8,000 characters, create `decision-traceability/decision-traceability-part-04.md`, update this index, and continue appending there.
