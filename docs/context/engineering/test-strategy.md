...
- Realtime live-event backend changes must cover public WebSocket gating for published public events, initial snapshot delivery, fanout after approve/reorder/live-state mutations, stable audience-safe payload shaping, and graceful rejection of unavailable event channels.
